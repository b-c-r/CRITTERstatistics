---
title: "**C**omplexity **r**educes the feed**i**ng s**t**reng**t**h of fr**e**shwater p**r**edators (CRITTER)"
...
ci_runs <- 1000                                                                # choose 10000 for publication output
```
...
```{r saveFigIeFuncResp, message=FALSE, warning=FALSE, include=FALSE}
## output for manuscript figure 2
jpeg(
  filename = here::here("figures","figure02.jpeg"),
  units = "cm",
  width = "20",
  height = "10",
  res = 300
...
```{r savefigNgFuncResp, message=FALSE, warning=FALSE, include=FALSE}
## output for manuscript figure 3
jpeg(
  filename = here::here("figures","figure03.jpeg"),
  units = "cm",
  width = "20",
  height = "15",
  res = 300
...
```{r savefigNgMod11vsMod15, message=FALSE, warning=FALSE, include=FALSE}
## output for manuscript figure 4
jpeg(
  filename = here::here("figures","figure04.jpeg"),
  units = "cm",
  width = "20",
  height = "10",
  res = 300
