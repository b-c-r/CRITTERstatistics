...
threads_hab_stats <- 8                                                          # number of threads that should be used for habitat statistics fitting
threads_plots <- 10                                                             # number of threads that should be used for plotting functions to create CI bands
```
