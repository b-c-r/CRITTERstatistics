...
subtitle: "Supplemental Statistics Report (v0.1.2)"
author:
...
```{r saveFigConcept, message=FALSE, warning=FALSE, include=TRUE}
## output for manuscript figure 1
jpeg(
  filename = here::here("figures","figure01.jpeg"),
  units = "cm",
  width = "20",
  height = "10",
  res = 300
...
```{r saveFigIeFuncResp, message=FALSE, warning=FALSE, include=TRUE}
...
```{r savefigNgFuncResp, message=FALSE, warning=FALSE, include=TRUE}
...
```{r savefigNgMod11vsMod15, message=FALSE, warning=FALSE, include=TRUE}
