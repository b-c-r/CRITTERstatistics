################################################################################
#   runs mod03 models and saves results                                        #
#                                                                              #
...
# fits model 03h to Ischnura data
...
saveRDS(mod03h_fit_ie, file = "results_hab_ie/mod03h_fit_ie.rds")               # save results

# fits model 03h to Notonecta data
mod03h_fit_ng <- mod03h_rrpe_fit(
...
saveRDS(mod03h_fit_ng, file = "results_hab_ng/mod03h_fit_ng.rds")               # save results



# fits model 03r to Ischnura data
mod03r_fit_ie <- mod03r_rrpe_fit(
  n_eaten = fr_data_ie$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ie$n_initial,                                             # data: number of prey provided initially, as integer
  n_rings = fr_data_ie$ring_count                                               # data: number of habitat structural elements (rings)
)
saveRDS(mod03r_fit_ie, file = "results_hab_ie/mod03r_fit_ie.rds")               # save results

# fits model 03r to Notonecta data
mod03r_fit_ng <- mod03r_rrpe_fit(
  n_eaten = fr_data_ng$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ng$n_initial,                                             # data: number of prey provided initially, as integer
  n_rings = fr_data_ng$ring_count                                               # data: number of habitat structural elements (rings)
)
saveRDS(mod03r_fit_ng, file = "results_hab_ng/mod03r_fit_ng.rds")               # save results
