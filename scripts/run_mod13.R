################################################################################
#   runs mod13 models and saves results                                        #
#                                                                              #
...
# fits model 13h to Ischnura data
...
saveRDS(mod13h_fit_ie, file = "results_hab_ie/mod13h_fit_ie.rds")               # save results

# fits model 13h to Notonecta data
mod13h_fit_ng <- mod13h_rrpe_fit(
...
saveRDS(mod13h_fit_ng, file = "results_hab_ng/mod13h_fit_ng.rds")               # save results



# fits model 13r to Ischnura data
mod13r_fit_ie <- mod13r_rrpe_fit(
  n_eaten = fr_data_ie$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ie$n_initial,                                             # data: number of prey provided initially, as integer
  complexity = fr_data_ie$complexity_level                                      # data: complexity levels
)
saveRDS(mod13r_fit_ie, file = "results_hab_ie/mod13r_fit_ie.rds")               # save results

# fits model 13r to Notonecta data
mod13r_fit_ng <- mod13r_rrpe_fit(
  n_eaten = fr_data_ng$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ng$n_initial,                                             # data: number of prey provided initially, as integer
  complexity = fr_data_ng$complexity_level                                      # data: complexity levels
)
saveRDS(mod13r_fit_ng, file = "results_hab_ng/mod13r_fit_ng.rds")               # save results
