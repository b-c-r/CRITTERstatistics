################################################################################
#   runs mod12 models and saves results                                        #
#                                                                              #
...
# fits model 12h to Ischnura data
...
saveRDS(mod12h_fit_ie, file = "results_hab_ie/mod12h_fit_ie.rds")               # save results

# fits model 12h to Notonecta data
mod12h_fit_ng <- mod12h_rrpe_fit(
  ...
  n_rings = fr_data_ng$ring_count,                                              # data: number of habitat rings provided as structure
  complexity = fr_data_ng$complexity_level                                      # data: complexity levels
)
saveRDS(mod12h_fit_ng, file = "results_hab_ng/mod12h_fit_ng.rds")               # save results



# fits model 12r to Ischnura data
...
saveRDS(mod12r_fit_ie, file = "results_hab_ie/mod12r_fit_ie.rds")               # save results

# fits model 12r to Notonecta data
mod12r_fit_ng <- mod12r_rrpe_fit(
  n_eaten = fr_data_ng$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ng$n_initial,                                             # data: number of prey provided initially, as integer
  n_rings = fr_data_ng$ring_count,                                              # data: number of habitat rings provided as structure
  complexity = fr_data_ng$complexity_level                                      # data: complexity levels
)
saveRDS(mod12r_fit_ng, file = "results_hab_ng/mod12r_fit_ng.rds")               # save results
