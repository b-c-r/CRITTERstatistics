################################################################################
#   runs mod15 models and saves results                                        #
#                                                                              #
...
# fits model 15h to Ischnura data
...
saveRDS(mod15h_fit_ie, file = "results_hab_ie/mod15h_fit_ie.rds")               # save results

# fits model 15h to Notonecta data
mod15h_fit_ng <- mod15h_rrpe_fit(
  ...
  n_rings = fr_data_ng$ring_count,                                              # data: number of habitat structural elements (rings)
  complexity = fr_data_ng$complexity_level                                      # data: complexity levels
)
saveRDS(mod15h_fit_ng, file = "results_hab_ng/mod15h_fit_ng.rds")               # save results



# fits model 15r to Ischnura data
...
saveRDS(mod15r_fit_ie, file = "results_hab_ie/mod15r_fit_ie.rds")               # save results

# fits model 15r to Notonecta data
mod15r_fit_ng <- mod15r_rrpe_fit(
  n_eaten = fr_data_ng$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ng$n_initial,                                             # data: number of prey provided initially, as integer
  n_rings = fr_data_ng$ring_count,                                              # data: number of habitat structural elements (rings)
  complexity = fr_data_ng$complexity_level                                      # data: complexity levels
)
saveRDS(mod15r_fit_ng, file = "results_hab_ng/mod15r_fit_ng.rds")               # save results
