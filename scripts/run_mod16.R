################################################################################
#   runs mod16 models and saves results                                        #
#                                                                              #
...
# fits model 16h to Ischnura data
...
saveRDS(mod16h_fit_ie, file = "results_hab_ie/mod16h_fit_ie.rds")               # save results

# fits model 16h to Notonecta data
mod16h_fit_ng <- mod16h_rrpe_fit(
...
saveRDS(mod16h_fit_ng, file = "results_hab_ng/mod16h_fit_ng.rds")               # save results



# fits model 16r to Ischnura data
mod16r_fit_ie <- mod16r_rrpe_fit(
  n_eaten = fr_data_ie$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ie$n_initial,                                             # data: number of prey provided initially, as integer
  complexity = fr_data_ie$complexity_level                                      # data: complexity levels
)
saveRDS(mod16r_fit_ie, file = "results_hab_ie/mod16r_fit_ie.rds")               # save results

# fits model 16r to Notonecta data
mod16r_fit_ng <- mod16r_rrpe_fit(
  n_eaten = fr_data_ng$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ng$n_initial,                                             # data: number of prey provided initially, as integer
  complexity = fr_data_ng$complexity_level                                      # data: complexity levels
)
saveRDS(mod16r_fit_ng, file = "results_hab_ng/mod16r_fit_ng.rds")               # save results
