################################################################################
#   runs mod05 models and saves results                                        #
#                                                                              #
...
# fits model 05h to Ischnura data
...
saveRDS(mod05h_fit_ie, file = "results_hab_ie/mod05h_fit_ie.rds")               # save results

# fits model 05h to Notonecta data
mod05h_fit_ng <- mod05h_rrpe_fit(
...
saveRDS(mod05h_fit_ng, file = "results_hab_ng/mod05h_fit_ng.rds")               # save results



# fits model 05r to Ischnura data
mod05r_fit_ie <- mod05r_rrpe_fit(
  n_eaten = fr_data_ie$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ie$n_initial,                                             # data: number of prey provided initially, as integer
  complexity = fr_data_ie$complexity_level                                      # data: complexity levels
)
saveRDS(mod05r_fit_ie, file = "results_hab_ie/mod05r_fit_ie.rds")               # save results

# fits model 05r to Notonecta data
mod05r_fit_ng <- mod05r_rrpe_fit(
  n_eaten = fr_data_ng$n_eaten,                                                 # data: number of prey eaten, as integer
  n_initial = fr_data_ng$n_initial,                                             # data: number of prey provided initially, as integer
  complexity = fr_data_ng$complexity_level                                      # data: complexity levels
)
saveRDS(mod05r_fit_ng, file = "results_hab_ng/mod05r_fit_ng.rds")               # save results
